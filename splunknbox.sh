...
#################################################################################
#	__VERSION: 4.4-192 $
#	__DATE: Tue Jan 02,2018 - 01:01:04AM -0600 $
...
GIT_VER=`echo "__VERSION: 4.4-192 $" | ggrep -Po "\d+.\d+-\d+"`
GIT_DATE=`echo "__DATE: Tue Jan 02,2018 - 01:01:04AM -0600 $GREP -Po "\w+\s\w+\s\d{2},\d{4}\s-\s\d{2}:\d{2}:\d{2}(AM|PM)\s-\d{4}" `
