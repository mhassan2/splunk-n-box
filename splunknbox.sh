...
#################################################################################
#	__VERSION: 4.4-197 $
#	__DATE: Tue Jan 02,2018 - 09:09:29AM -0600 $
...
GIT_VER=`echo "__VERSION: 4.4-197 $" | ggrep -Po "\d+.\d+-\d+"`
GIT_DATE=`echo "__DATE: Tue Jan 02,2018 - 09:09:29AM -0600 $GREP -Po "\w+\s\w+\s\d{2},\d{4}\s-\s\d{2}:\d{2}:\d{2}(AM|PM)\s-\d{4}" `
