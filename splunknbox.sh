...
GIT_VERSION: 4.4-38
#	_VERSION: 4.4-38
#	_DATE:    Sun Dec 31,2017 - 10:22:57PM -0600
...
# Version:	 	see $GIT_VERSION: 4.4-38
#
...
LINE6="<CENTER><font color=\"#867979\">Created using Splunk N' Box v$GIT_VERSION: 4.4-38
...
printf "${BoldWhiteOnTurquoise}Splunk n' Box v$GIT_VERSION: 4.4-38
display_stats_banner
...
read -p "Are you sure you want to proceed? [y/N]? " answer
	...
	#		sudo rm -rf /usr/local/Homebrew/
	 	...
	 	printf "\n\n"
                echo -e "Life is good! Thank you for using Splunk n' Box v$GIT_VERSION: 4.4-38
...
colored_git_version=`echo $GIT_VERSION: 4.4-38
...
new=""
#newveralert=`awk -v n1=$online_ver -v n2=$GIT_VERSION: 4.4-38
new=`awk -v n1=$online_ver -v n2=$GIT_VERSION: 4.4-38
if [ "$new" == "Y" ]; then
