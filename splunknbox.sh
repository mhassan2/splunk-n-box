...
#################################################################################
#	__VERSION: 4.4-166 _
#	__DATE: Mon Jan  1 23:51:52 CST 2018 _
#	__AUTHOR: mhassan2 <mhassan@splunk.com> _

#date1=`echo __DATE: Mon Jan  1 23:51:52 CST 2018 _ | ggrep -Po "__DATE: Mon Jan 01,2018 - 11:23:40PM -0600 _ Mon Jan 01,2018 - 11:23:37PM -0600 _\s+\w+\s+\w+\s+\d{2},\d{4}\s-\s\d{2}:\d{2}:\d{2}(PM|AM)\s-\d{4}" `
#ggrep -Po "__DATE: Mon Jan  1 23:51:52 CST 2018 _: Mon Jan 01,2018 - 11:23:40PM -0600 _ Mon Jan 01,2018 - 11:23:37PM -0600 _\s+\w+\s+\w+\s+\d{2},\d{4}\s-\s\d{2}:\d{2}:\d{2}(PM|AM)\s-\d{4}"

var=`echo "__DATE: Mon Jan  1 23:51:52 CST 2018 _" | ggrep -Po "\s+\w+\s+\w+\s+\d+\s\d{2}:\d{2}:\d{2}\sCST\s\d{4}" `
echo "var[$var]"
